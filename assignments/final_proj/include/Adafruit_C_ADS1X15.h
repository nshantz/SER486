#ifndef ADAFRUIT_C_ADS1X15_H_
#define ADAFRUIT_C_ADS1X15_H_
...
struct Adafruit_ADS1015{
	...
	uint8_t m_bitShift;
	adsGain_t m_gain;
	int m_wiringPiAddress;
};
//This is the struct to manage the values of each instance of the ADS1115 Board (my board)
...
void initModule_default(int choice, struct Adafruit_ADS1115* ptr);
//range of addresses is 0x48 - 0x4B
void initModule_Address(int choice, uint8_t i2cAddress, struct Adafruit_ADS1115* ptr);
